<template>
  <div class="h-screen md:flex">
    ...
    <div class="flex w-1/2 bg-white justify-center">
      <div class="py-10 md:w-1/2 flex items-center">
      ...
      <a href="/">
        <h1 class="mt-10 mr-0 text-indigo-600 font-bold text-2xl">Job Portal</h1>
      </a>
    </div>
  </div>
</template>
