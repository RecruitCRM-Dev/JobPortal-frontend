        ...
        <div class="max-w-4xl mx-auto p-3">
          ...
          >
            <div>
              ...
              <router-link
                to="/job/1/apply"
                class="font-bold mt-px"
                :class="{ 'border-b-4 border-indigo-300': $route.path === '/job/1/apply' }"
                >{{ job.data.attributes.title }}</router-link
              >
...
onMounted(async () => {
  ...
  try {
    const res = await axios.get('/api/employer/5/job')
    console.log(res)
