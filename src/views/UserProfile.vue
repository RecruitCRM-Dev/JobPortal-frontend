<template>
  <div class="bg-black h-10 text-white flex justify-center">I am the navbar</div>
  <section class="bg-white">
    <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
      <h2 class="mb-4 text-xl font-bold text-gray-900">Edit your user profile</h2>
      <form action="#">
        <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
          <div class="h-24 max-w-24">
            <img
